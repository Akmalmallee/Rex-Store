...
<div class="max-w-2xl mx-auto space-y-6">
    <div>
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update coupon information</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800/50 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700/50">
        <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST" class="p-6 space-y-6">
            ...
            <div>
                ...
                <input type="number" id="value" name="value" value="{{ old('value', $coupon->value) }}" required min="0" step="0.01"
            ...
            <div>
                ...
                <input type="number" id="min_order" name="min_order" value="{{ old('min_order', $coupon->min_order) }}" min="0" step="0.01"
            ...
            <div>
                ...
                <input type="date" id="expires_at" name="expires_at" value="{{ old('expires_at', $coupon->expires_at ? $coupon->expires_at->format('Y-m-d') : '') }}"
